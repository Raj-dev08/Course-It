...
export const useAuthStore = create((set, get) => ({
  ...
  beAdmin: async (data) => {
    try {
      await axiosInstance.post("/user/be-admin",{password:data});
  ...
  cancelAdmin:async () => {
    try {
      await axiosInstance.post("/user/cancel-admin");
  ...
  updateBalance: async(amount)=>{
    try{
      const res=await axiosInstance.post("/user/update-balance",{amount})
